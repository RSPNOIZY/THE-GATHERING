/**
 * NOIZYVOX.COM — Holding Page
 * Platinum wordmark. 396 Hz universe. Voice sovereignty portal. Coming soon.
 *
...
<title>NOIZYVOX — Coming Soon</title>
<meta name="description" content="NOIZYVOX. Your voice. Your consent. Your kingdom. A NOIZY Empire portal. 2026.">
...
.wordmark{
  ...
  filter:drop-shadow(0 0 60px rgba(233,69,96,.08)) drop-shadow(0 4px 20px rgba(0,0,0,.5));
  opacity:0;animation:fade 4s cubic-bezier(.16,1,.3,1) .3s forwards;user-select:none;
}
.wordmark .vox{background:linear-gradient(180deg,#e94560,#ff6b85);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text}
.tag{
...
.doctrine{
  ...
  color:rgba(233,69,96,.35);letter-spacing:.15em;margin-top:2.5rem;line-height:2.2;
...
.foot{position:absolute;bottom:2rem;left:0;right:0;text-align:center;
  ...
  color:rgba(200,196,188,.15);opacity:0;animation:fade 2s ease 5s forwards;
}
...
<canvas id="u"></canvas>
<div class="wrap">
  <div class="wordmark">NOIZY<span class="vox">VOX</span></div>
  <div class="tag">Your Voice · Your Consent · Your Kingdom</div>
  <div class="doctrine">
    consent as <span>executable code</span><br>
    provenance as <span>default</span><br>
    revocation as <span>sacred</span>
  </div>
  <div class="coming">LAUNCHING <em>2026</em> · A <em>NOIZY EMPIRE</em> PORTAL</div>
</div>
<div class="foot">
...
let W,H,T=0;
const PAL=[[233,69,96],[212,160,23],[0,212,255],[155,89,182],[255,200,120]];
