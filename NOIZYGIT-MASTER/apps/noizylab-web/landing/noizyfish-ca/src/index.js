/**
 * NOIZYFISH.CA — Holding Page
 * The Canadian portal. Red maple accent. 396 Hz universe.
 *
...
<title>NOIZYFISH.CA — The Canadian Portal</title>
<meta name="description" content="NOIZYFISH.CA — The fish returns home. A NOIZY Empire portal. Canada, 2026.">
...
.wordmark{
  ...
  filter:drop-shadow(0 0 60px rgba(255,68,68,.1)) drop-shadow(0 4px 20px rgba(0,0,0,.5));
  opacity:0;animation:fade 4s cubic-bezier(.16,1,.3,1) .3s forwards;user-select:none;
}
.wordmark .fin{background:linear-gradient(180deg,#ff4444,#ff8080);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text}
.ca{
  font-family:'Cinzel',serif;font-size:clamp(.9rem,2.4vw,1.3rem);
  letter-spacing:.55em;text-transform:uppercase;color:rgba(255,68,68,.5);
  margin-top:.5rem;opacity:0;animation:fade 3s ease 1.5s forwards;
}
.ca .dot{color:rgba(255,68,68,.8)}
.tag{
...
.maple{font-size:1.6em;margin:0 .3em;filter:drop-shadow(0 0 12px rgba(255,68,68,.4))}
.doctrine{
  font-family:"SF Mono","Fira Code",monospace;font-size:clamp(.55rem,1vw,.72rem);
  color:rgba(255,68,68,.4);letter-spacing:.15em;margin-top:2.8rem;line-height:2.2;
...
.foot a{color:rgba(255,68,68,.45);text-decoration:none}
.foot a:hover{color:rgba(255,68,68,.75)}
...
<div class="wrap">
  ...
  <div class="ca"><span class="dot">.</span>CA</div>
  <div class="tag"><span class="maple">🍁</span> The Fish Returns Home <span class="maple">🍁</span></div>
  <div class="doctrine">
    made in <span>Montréal</span><br>
    protected by <span>consent</span><br>
    powered by <span>noizy</span>
  </div>
  <div class="coming">LAUNCHING <em>2026</em> · A <em>NOIZY EMPIRE</em> PORTAL · CANADA</div>
</div>
<div class="foot">
...
let W,H,T=0;
const PAL=[[255,68,68],[255,128,128],[212,160,23],[248,248,248],[200,196,188]];
