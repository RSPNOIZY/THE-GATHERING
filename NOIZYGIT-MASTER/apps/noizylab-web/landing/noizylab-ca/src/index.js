/**
 * NOIZYLAB.CA — Holding Page
 * The Canadian laboratory. Purple + maple. 396 Hz universe.
 *
...
<title>NOIZYLAB.CA — Experiments From the North</title>
<meta name="description" content="NOIZYLAB.CA. The Canadian laboratory of the NOIZY Empire. Made in Montréal. 2026.">
...
.ca{
  ...
  letter-spacing:.55em;text-transform:uppercase;color:rgba(255,68,68,.45);
...
.tag{
  ...
  margin-top:1.4rem;opacity:0;animation:fade 3s ease 2.5s forwards;
}
.maple{font-size:1.5em;margin:0 .3em;filter:drop-shadow(0 0 12px rgba(255,68,68,.4))}
.doctrine{
  font-family:"SF Mono","Fira Code",monospace;font-size:clamp(.55rem,1vw,.72rem);
  color:rgba(155,89,182,.42);letter-spacing:.15em;margin-top:2.6rem;line-height:2.2;
...
<div class="wrap">
  ...
  <div class="tag"><span class="maple">🍁</span> Experiments From the North <span class="maple">🍁</span></div>
  <div class="doctrine">
    made in <span>Montréal</span><br>
    research with <span>reverence</span><br>
    prototypes of <span>sovereignty</span>
  </div>
  <div class="coming">OPENING <em>2026</em> · A <em>NOIZY EMPIRE</em> LABORATORY · CANADA</div>
</div>
<div class="foot">
  <p>396 Hz — Liberation · <a href="https://noizy.ai">noizy.ai</a> · rsp@noizylab.ca</p>
</div>
<script>
const C=document.getElementById('u'),X=C.getContext('2d');
let W,H,T=0;
const PAL=[[155,89,182],[255,68,68],[212,160,23],[248,248,248],[80,140,220]];
