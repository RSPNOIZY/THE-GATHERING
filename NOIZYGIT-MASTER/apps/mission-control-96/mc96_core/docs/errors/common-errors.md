...
```bash
# Create or edit ~/Desktop/HEAVEN/.wranglerignore
echo "ARCHIVE/" >> ~/Desktop/HEAVEN/.wranglerignore
echo "*.wav" >> ~/Desktop/HEAVEN/.wranglerignore
echo "*.mp3" >> ~/Desktop/HEAVEN/.wranglerignore
echo ".git/" >> ~/Desktop/HEAVEN/.wranglerignore
```
...
```bash
du -sh ~/Desktop/HEAVEN/* | sort -rh | head -20
```
