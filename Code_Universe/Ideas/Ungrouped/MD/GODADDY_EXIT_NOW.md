...
4. ~~**M365 email** — Are you currently using Microsoft 365 for `rsp@noizyfish.com`? If yes, when can we kill it?~~ **ANSWERED 2026-04-18:** M365 exit ratified. `rsplowman@outlook.com` inactive/bouncing (see `TASKS.md`). All mail flows CF Email Routing → `rsplowman@icloud.com`. Canonical: `ops/DNS_CORRECTNESS_PLAN.md`.
