...
| **noizyvox** | `NOIZYANTHROPIC/NOIZYLAB/noizyvox/` | NOIZYVOX implementation (API clients, models) | 🟡 MEDIUM |
...
├── docs/
│   ├── archive/
│   │   ├── 03_PRODUCTS/              ← DreamChamber specs, NOIZYVOX doctrine, product blueprints
