...
const TRANSCRIPT_DIR = process.env.TRANSCRIPT_DIR || join(homedir(), "NOIZYLAB", "transcripts");
...
function processTranscript(filePath) {
  try {
    ...
    writeFileSync(join(ARCHIVE_DIR, `${intakeId}.json`), JSON.stringify(archiveRecord, null, 2));
